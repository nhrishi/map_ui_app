...
const headRows = [
  { id: 'mapId', numeric: false, disablePadding: true, label: 'MAP Id' },
  { id: 'mapType', numeric: true, disablePadding: false, label: 'MAP Type' },
  { id: 'country', numeric: true, disablePadding: false, label: 'Country of Request)' },
  { id: 'cmr', numeric: true, disablePadding: false, label: 'CMR' },
  { id: 'product', numeric: true, disablePadding: false, label: 'Product' },
  { id: 'strength', numeric: false, disablePadding: true, label: 'Strength' },
  ...
  { id: 'shipmentStatus', numeric: false, disablePadding: true, label: 'Shipment Status' }
          ...
          >
            ...
            <TableBody>
              {stableSort(rows, getSorting(order, orderBy))
                ...
                .map((row, index) => {
                  const isItemSelected = isSelected(row.mapId);
                  const labelId = `enhanced-table-checkbox-${index}`;

                  return (
                    <TableRow
                      hover
                      onClick={event => handleClick(event, row.mapId)}
                      role="checkbox"
                    ...
                    >
                      ...
                      <TableCell align="right">{row.mapType}</TableCell>
                      <TableCell align="right">{row.country}</TableCell>
                      <TableCell align="right">{row.cmr}</TableCell>
                      <TableCell align="right">{row.product}</TableCell>
                      <TableCell align="left" scope="row" padding="none">{row.strength}</TableCell>
                      <TableCell align="left" scope="row" padding="none">{row.quantity}</TableCell>
                      <TableCell align="left" scope="row" padding="none">{row.owner}</TableCell>
                      <TableCell align="left" scope="row" padding="none">{row.status}</TableCell>
                      <TableCell align="left" scope="row" padding="none">{row.shipmentStatus}</TableCell>
