...
const headRows = [
  ...
  { id: 'molecule', numeric: true, disablePadding: false, label: 'Molecule' },
  { id: 'strength', numeric: true, disablePadding: false, label: 'Strength (mg)' },
  { id: 'presentation', numeric: true, disablePadding: false, label: 'Presentation (unit)' },
                ...
                .map((row, index) => {
                  ...
                  return (
                    ...
                    >
                      ...
                      <TableCell align="right">{row.molecule}</TableCell>
                      ...
                      <TableCell align="left" scope="row" padding="none">{row.country}</TableCell>
                      <TableCell align="left" scope="row" padding="none">{row.source}</TableCell>
